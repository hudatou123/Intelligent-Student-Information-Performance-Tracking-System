...
export default function Students() {
  ...
  const { data, isLoading, isError, refetch } = useQuery({
    ...
    queryFn: () => studentApi.getAll(page, PAGE_SIZE, search),
  })
  ...
  const openEdit = (student: Student) => {
    ...
    setValue('studentNumber', student.studentNumber)
  ...
  return (
    <div className="space-y-5">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-0.5">
            Manage student records ({data?.totalElements ?? 0} total)
          </p>
        </div>
      ...
      <Modal
        ...
        description={
          editingStudent
            ? `Editing ${editingStudent.fullName}`
      ...
      >
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <Input
            ...
            helperText={editingStudent ? 'Student number cannot be changed.' : undefined}
          />
      ...
      <ConfirmDialog
        ...
        description={`Are you sure you want to delete ${deletingStudent?.fullName}? This action cannot be undone and will also remove all associated grades.`}
        confirmLabel="Delete"
